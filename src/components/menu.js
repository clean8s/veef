...
import { html } from "@web-mjs/preact"

const Menu = (props) => {
        return html`
            <div class="relative flex-grow" style="background: #fafafa">
                <div class="flex flex-col sm:flex-row sm:justify-around">
                    <div class="w-72 h-screen">
                        ...
                        Element
                            ...
                            <a class="hover:text-gray-800 hover:bg-gray-100 flex items-center p-2 my-6 transition-colors dark:hover:text-white dark:hover:bg-gray-600 duration-200  text-gray-800 dark:text-gray-100 rounded-lg bg-gray-200" href="#">
                                <svg width="20" height="20" fill="currentColor" class="m-auto" viewBox="0 0 2048 1792" xmlns="http://www.w3.org/2000/svg">
...
Menu.config = {
    rootStyle: css`:host{position: fixed; inset: 0; right: auto; display: flex; flex-direction: column;}`
}
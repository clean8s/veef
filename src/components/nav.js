...
class NavWrap extends LitElement {
    render() {
        return html`<div class="grid grid-cols-[18rem,1fr,min-content]">
            <div class="w-72">
            </div>
            <div><slot></slot></div>
        </div>
...
class Nav extends LitElement {
    // static rootStyle = css`:host{display:block;position:absolute;inset:0;right:auto !important;z-index:100}`
    constructor() {
        super();
    }
    render() {
        return html`
            <nav class="bg-gray-100 mb-10 dark:bg-gray-800">
